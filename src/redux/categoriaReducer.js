    ...
    try{
        ...
        if(dados.status){
            ...
            return {
                status: false,
                listaCategorias: [],
                mensagem: "Ocorreu um problema ao recuperar as categorias da base de dados."
            }
        }
    }
    catch(erro){
        return {
            status: false,
            listaCategorias: [],
            mensagem: "Ocorreu um problema ao recuperar as categorias da base de dados: " + erro.message
        }
    }
});
...
export const adicionarCategoria= createAsyncThunk("categoria/adicionar", async (categoria)=>{
    ...
    .catch((erro)=>{
        return {
            status: false,
            mensagem: "Ocorreu um erro ao adicionar categoria: " + erro.message
        }
    });
    if(resposta.ok){
        const dados = await resposta.json();
        ...
        return {
            status: false,
            mensagem: "Ocorreu um erro ao adicionar categoria.",
            categoria
        }
    }
});
...
export const removerCategoria = createAsyncThunk("categoria/remover", async (categoria)=>{
    ...
    if(resposta.ok){
        ...
        return {
            status: false,
            mensagem: "Ocorreu um problema ao remover a categoria.",
            categoria
        }
    }
})
